 ...
 * </p>
 * 
 * Instances of this class represent an individual shelf. A shelf is a container
 * widget similar to a tab folder but with a list-like visualization.
 * <p>
 * Add controls to a shelf item by constructing them on the body (
 * <code>getBody</code>) of the item.
 * <dl>
 * <dt><b>Styles:</b></dt>
 * <dd>(none)</dd>
 * <dt><b>Events:</b></dt>
...
public class PShelfItem extends Item {
	 ...
	 * <code>PShelf</code>), a style value describing its behavior and
	...
	/**
	 * Constructs a new instance of this class given its parent (which must be a
	 * <code>PShelf</code>) and a style value describing its behavior and
	...
	/**
	 * Returns the client area of the shelf. Users should add controls and a
	 * layout to the body.
	 * <p>
	 * 
